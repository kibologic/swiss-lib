...
# Plugin Migration for <!-- MOVED TO INTERNAL: Phase 4 -->

<!-- MOVED TO INTERNAL: Phase 4 --> stabilizes the plugin lifecycle and security auditing flow. This page summarizes required updates for plugin authors.
