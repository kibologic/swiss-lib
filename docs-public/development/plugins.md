...
# Plugin Development (<!-- MOVED TO INTERNAL: Phase 4 -->)

This page defines the stable plugin contract, lifecycle, service registry, and capability audit for <!-- MOVED TO INTERNAL: Phase 4 -->. The new lifecycle path is feature-flagged and OFF by default.
...
- <!-- MOVED TO INTERNAL: Phase 4 --> additions (optional):
