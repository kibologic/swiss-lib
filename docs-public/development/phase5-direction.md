...
# <!-- MOVED TO INTERNAL: Phase 5 --> Direction

Great—<!-- MOVED TO INTERNAL: Phase 5 --> is where we turn SwissJS from “stable library with strong guardrails” into a polished product with a growing ecosystem and enterprise runway.

## <!-- MOVED TO INTERNAL: Phase 5 --> Objectives
...
- Deliverables:
  ...
  - SemVer + deprecation policy in `docs/development/public-vs--api.md`.
...
## Working Mode (<!-- MOVED TO INTERNAL: Phase 5 -->)
