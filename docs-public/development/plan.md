...
# SwissJS <!-- MOVED TO INTERNAL: Development Plan --> (Phases 4–6)
...
## <!-- MOVED TO INTERNAL: Phase 4 -->: Plugin System Enhancement

### Goals

- Solidify `PluginManager` integration with capabilities (beyond <!-- MOVED TO INTERNAL: Phase 1 --> sync).
...
- <!-- MOVED TO INTERNAL: PR1 -->: Stable plugin types + lifecycle contract + barrel fixes.
- <!-- MOVED TO INTERNAL: PR2 -->: PluginManager capability audit + service registry + logging.
- <!-- MOVED TO INTERNAL: PR3 -->: Test expansion (core + file-router + compile hook).

---

## <!-- MOVED TO INTERNAL: Phase 5 -->: <!-- MOVED TO INTERNAL: Developer Tools -->
...
- <!-- MOVED TO INTERNAL: PR4 --> is implemented:
...
- <!-- MOVED TO INTERNAL: PR4 -->: Deterministic docs runner + CI workflows (barrels/API report). [COMPLETED]
- <!-- MOVED TO INTERNAL: PR5 -->: Bundle analysis integration + developer conventions docs.

---

## <!-- MOVED TO INTERNAL: Phase 6 -->: Advanced Features
...
- <!-- MOVED TO INTERNAL: PR6 -->: Explorer capability graph + runtime hook wiring.
- <!-- MOVED TO INTERNAL: PR7 -->: Template pipeline wiring + SSR/streaming tests.
- <!-- MOVED TO INTERNAL: PR8 -->: Capability resolution improvements + diagnostics.

---

## CI and Versioning Gates

- Changesets independent versions per package;  prereleases when needed.
- CI gates: lint, type-check, tests, docs, barrels/API report, bundle budgets.
- Release:  prerelease tags for sprint drops.
...
### <!-- MOVED TO INTERNAL: Phase 4 --> — Plugin System Enhancement (Detailed)
...
### <!-- MOVED TO INTERNAL: Phase 5 --> — <!-- MOVED TO INTERNAL: Developer Tools --> (Detailed)
...
### <!-- MOVED TO INTERNAL: Phase 6 --> — Advanced Features (Detailed)
...
- <!-- MOVED TO INTERNAL: PR1 --> (<!-- MOVED TO INTERNAL: Phase 4 -->): Types + lifecycle contract + barrels (no runtime change).
- <!-- MOVED TO INTERNAL: PR2 --> (<!-- MOVED TO INTERNAL: Phase 4 -->): PluginManager lifecycle + capability audit + service registry + logging (feature-flagged).
- <!-- MOVED TO INTERNAL: PR3 --> (<!-- MOVED TO INTERNAL: Phase 4 -->): Tests (core + file-router + compile hook) and docs.
- <!-- MOVED TO INTERNAL: PR4 --> (<!-- MOVED TO INTERNAL: Phase 5 -->): Deterministic docs runner + CI workflows (barrels/API report).
- <!-- MOVED TO INTERNAL: PR5 --> (<!-- MOVED TO INTERNAL: Phase 5 -->): Bundle analysis + developer conventions docs.
- <!-- MOVED TO INTERNAL: PR6 --> (<!-- MOVED TO INTERNAL: Phase 6 -->): Explorer capability graph + runtime hook wiring.
- <!-- MOVED TO INTERNAL: PR7 --> (<!-- MOVED TO INTERNAL: Phase 6 -->): Template pipeline wiring + SSR/streaming tests.
- <!-- MOVED TO INTERNAL: PR8 --> (<!-- MOVED TO INTERNAL: Phase 6 -->): Capability resolution improvements + diagnostics.
