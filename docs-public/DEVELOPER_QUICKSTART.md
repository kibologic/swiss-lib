...
This guide gets you productive on SwissJS across Windows, macOS, and Linux. It complements the architecture docs in `docs/README.md` and the authoritative <!-- MOVED TO INTERNAL: Phase 6 --> plan in `docs/PHASE6_PLAN.md`.

- Core architecture: see `docs/README.md`
- <!-- MOVED TO INTERNAL: Phase 6 --> work plan: see `docs/PHASE6_PLAN.md`
...
## <!-- MOVED TO INTERNAL: Phase 6 --> Focus (What We’re Building Now)
...
If anything here becomes outdated, submit a PR updating this page and, if needed, the <!-- MOVED TO INTERNAL: Phase 6 --> plan. This page should remain minimal, practical, and cross‑platform.
