...
### <!-- MOVED TO INTERNAL: Phase 1 -->: Router Core
...
### <!-- MOVED TO INTERNAL: Phase 2 -->: Nested Layouts & Data Loading
...
### <!-- MOVED TO INTERNAL: Phase 3 -->: SSR/SSG Pipeline
...
### <!-- MOVED TO INTERNAL: Phase 4 -->: API Routes
...
- **<!-- MOVED TO INTERNAL: Phase 1 -->**: 2 weeks
- **<!-- MOVED TO INTERNAL: Phase 2 -->**: 1 week
- **<!-- MOVED TO INTERNAL: Phase 3 -->**: 2 weeks
